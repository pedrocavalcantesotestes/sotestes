...
if($_SERVER['DOCUMENT_ROOT'][strlen($_SERVER['DOCUMENT_ROOT'])-1] == "/"){
 ...
 if (strpos($_SERVER['HTTP_HOST'], "www.") !== FALSE) {
    $novo = str_replace("www.", "", $_SERVER['HTTP_HOST']);
    header("Location: http://{$novo}{$_SERVER['REQUEST_URI']}");
    exit;
}else if($_SERVER['HTTP_HOST'] == "pt.sotestes.com"){
    header("Location: http://sotestes.com{$_SERVER['REQUEST_URI']}");
    exit;
}
/*
 * ---------------------------------------------------------------
...
require_once FCPATH . 'application/libraries/Cliente.php';
