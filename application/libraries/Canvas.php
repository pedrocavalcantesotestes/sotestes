...
// fim dadosImagem
    ...
    public function carrega($origem = '') {
        ...
        $this->origem = Utilitario::urlToFile($origem);
        $this->dados();
        return $this;
    }
...
// fim validaImagem
    ...
    public function novaImagem($largura, $altura) {
        ...
        $white = imagecolorallocatealpha($this->img, 255, 255, 255, 127);
        ...
        if ($imagem) {
            ...
            switch (strtolower($pathinfo['extension'])) {
                ...
                case 'png':
                    ...
                    $marcadagua = imagecreatefromstring(file_get_contents($imagem));
